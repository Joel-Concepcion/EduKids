  ...
  return (
    <View style={styles.container}>
      <View style={styles.conFor}>
        ...
        <TextInput style={[styles.texImp, styles.font1]} value={nombreColegio} onChangeText={setNombreColegio} />

        <Text style={[styles.tex, styles.font]}>Nombre, Apellido del alumno</Text>
        <TextInput style={[styles.texImp, styles.font1]} value={nombreAlumno} onChangeText={setNombreAlumno} />

        <Text style={[styles.tex, styles.font]}>Código del alumno</Text>
        <TextInput style={[styles.texImp, styles.font1]} value={codigoAlumno} onChangeText={setCodigoAlumno} />
