...
const ACTIVIDAD_META = {
  'Juego de Sumas Manzana': {
    id: 'Juego-Sumas-Manzana',
    nombre: 'Juego de Sumas Manzana',
    categoria: 'Matemática',
    bannerKey: 'Juego-Sumas-Manzana',
    imagen: require('../../../assets/game/matemática/sumaManzana.png'),
    screen: 'Juego de Sumas Manzana'
  },
  'Juego de Sumas': {
    id: 'juego-suma',
